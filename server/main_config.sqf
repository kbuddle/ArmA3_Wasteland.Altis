...
A3W_timeMultiplierNight = 9.0;     // Sets the speed of time between 8 PM and 5 AM
...
A3W_atmMaxBalance = 15000000;       // Maximum amount of money that can be stored in a bank account (don't go over 16777216 as numbers start losing accuracy)
A3W_atmTransferFee = 50;            // Fee in percent charged to players for money transfers to other players (0 to 50)
...
A3W_payrollInterval = 120*60;       // Delay in seconds between each payroll
...
A3W_PriorityMissionDelay = 30*60;   // Time in seconds between Priority Missions 40*60
A3W_PriorityMissionTimeout = 60*60;// Time in seconds that a Priority Mission will run for, unless completed
A3W_AirMissionDelay = 30*60;        // Time in seconds between Air Missions 30*60
A3W_AirMissionTimeout = 15*60;      // Time in seconds that a Air Mission will run for, unless completed 
A3W_AssaultMissionDelay = 5*60;     // Time in seconds between Assault Missions 15*60
A3W_AssaultMissionTimeout = 60*60;  // Time in seconds that a Assault Mission will run for, unless completed
...
Tier_2_Reward = 25000;				//Default $10,000
Tier_3_Reward = 50000;				//Default $15,000
Tier_4_Reward = 75000;				//Default $25,000
Tier_5_Reward = 100000;				//Default $40,000

//Testing settings - not yet implemented
A3W_enableTestMissions = 1;       // Allow test missions to run (0 = no, 1 = yes)
A3W_testMissionDelay = 20*60; 		// Time in seconds between test Missions
A3W_testMissionTimeout = 90*60;		// Time in seconds that a test Mission will run for, unless completed
//A3W_reduceMissionTimeDelays = 1;  // Factor to reduce intermisison time for testing (0.1 to 1 for no reduction)
//A3W_reduceMissionTimeTimeout = 1; // Factor to reduce misison timeout setting for testing (0.1 to 1 for no reduction)