...
_radius =  _this select 3; // param [3, 10, [0]];
 diag_log format ["CUSTOMGROUP6 - _group %1, _pos %2, _NBUnits %3, _radius %4", _group, _pos, _nbUnits, _radius ];
_unitTypes =
[
...
for "_i" from 1 to _nbUnits do
{
 ...
 diag_log format ["CUSTOMGROUP6 - _unit %1", _unit];
...
diag_log format ["CUSTOMGROUP6 group formed %1", _group];
