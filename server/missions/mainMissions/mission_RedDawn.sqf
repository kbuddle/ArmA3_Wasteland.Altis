...
_setupObjects =
{
	...
	_missionHintText = format ["Hostile forces have parachuted over <br/><t size='1.25' color='%1'>%2</t><br/><br/>Kill them and take their supplies before they run rampant!", mainMissionColor, (_town select 2)];
