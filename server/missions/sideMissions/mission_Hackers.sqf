...
_setupObjects =
{
	...
	[_aiGroup,_missionPos,24,20] call createCustomGroup4;

	_aiGroup setCombatMode "RED";
	_aiGroup setBehaviour "COMBAT";	
	
	_vehicleName = "Laptop";
	_missionHintText = format ["<t color='%2'>Hackers</t> are using a laptop to hack everyone's browser history. Stop the hack and you will be rewarded!", _vehicleName, sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["The laptop is hacked. Congratulations you stopped everyone's porn history being made public!"];
};
