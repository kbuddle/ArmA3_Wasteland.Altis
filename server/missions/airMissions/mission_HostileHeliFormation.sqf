...
_setupObjects =
{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "B_Heli_Transport_01_F"):
			{
			...
			case (_type isKindOf "B_Heli_Attack_01_F" || _type isKindOf "O_Heli_Attack_02_F"):
			{
	...
	_aiGroup setCombatMode "RED"; // fire at will engage at will
	_aiGroup setBehaviour "COMBAT"; // actively engage
