...
A3W_AirMissionDelay = 20*60;        // Time in seconds between Air Missions 20*60
...
A3W_testMissionDelay = 2*60; 		// Time in seconds between test Missions
A3W_testMissionTimeout = 20*60;		// Time in seconds that a test Mission will run for, unless completed
