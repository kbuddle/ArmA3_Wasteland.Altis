...
[
	...
	"launch_Titan_F",	//Titan MPRL AA (Sand)
	"launch_Titan_short_F"	//Titan MPRL Compact (Sand)
];
...
[
	...
	"SmokeShellYellow", // Toxic Gas Grenade (Yellow)
...
[
	...
	"hgun_Pistol_Signal_F", // Flare Pistol
...
_overallLoopAmount = floor (round (random 6) + 4); // minimum 4, maximum 8

_backPackAmount = floor (round (random 2) + 1); // minimum 1, maximum 3
_binocularAmount = floor (round (random 3) + 2); // minimum 2, maximum 5
_bipodAmount = floor (round (random 2) + 1); // minimum 1, maximum 3
_headGearAmount = floor (round (random 2) + 1); // minimum 1, maximum 3
_itemAmount = floor (round (random 3) + 5); // minimum 5, maximum 8
_launcherAmount = floor (round (random 2) + 2); // minimum 2, maximum 4
_magazineAmount = floor (round (random 10) + 10); // minimum 10, maximum 20
_throwableAmount = floor (round (random 3) + 3); // minimum 3, maximum 6
_muzzleAmount = floor (round (random 2) + 2); // minimum 2, maximum 4
_opticAmount = floor (round (random 3) + 3); // minimum 3, maximum 6
_primaryWeaponAmount = floor (round (random 5) + 3); // minimum 3, maximum 8
_secondaryWeaponAmount = floor (round (random 3) + 2); // minimum 2, maximum 5
_uniformAmount = floor (round (random 2) + 1); // minimum 1, maximum 3
_vestAmount = floor (round (random 2) + 1); // minimum 1, maximum 7
