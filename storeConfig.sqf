...
[
	...
	["AKS-74U Carbine", "arifle_AKS_F", 3000],
	["AKM Rifle", "arifle_AKM_F", 3000],
	["AK-12 Rifle", "arifle_AK12_F", 4000],
	["AK-12 GL Rifle", "arifle_AK12_GL_F", 4000],

	// Marksman Rifles
	["MXM Rifle", "arifle_MXM_F", 1800],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 1800],
	["MXM Rifle (Khaki)", "arifle_MXM_khk_F", 1800, "noDLC"],
	["Rahim DMR Rifle", "srifle_DMR_01_F", 1850],
	["Mk18 ABR Rifle", "srifle_EBR_F", 1900],

	// DLC
	["CMR-76 Stealth Rifle", "srifle_DMR_07_blk_F", 2000],
	["CMR-76 Stealth Rifle (Hex)", "srifle_DMR_07_hex_F", 2000],
	["CMR-76 Stealth Rifle (G Hex)", "srifle_DMR_07_ghex_F", 2000],
...
[
	...
	["RPG-42 Alamut", "launch_RPG32_F", 1250],
	["RPG-42 Alamut (G Hex)", "launch_RPG32_ghex_F", 1250, "noDLC"],
	["PCML", "launch_NLAW_F", 1500],
	["MAAWS Mk4 Mod 0 (Green)", "launch_MRAWS_green_rail_F", 1500, "noDLC"], // RPG-42 and MAAWS are similar, but MAAWS has longer range
	["MAAWS Mk4 Mod 0 (Olive)", "launch_MRAWS_olive_rail_F", 1500, "noDLC"],
	["MAAWS Mk4 Mod 0 (Sand)", "launch_MRAWS_sand_rail_F", 1500, "noDLC"],
	...
	["MAAWS Mk4 Mod 1 (Olive)", "launch_MRAWS_olive_F", 2150, "noDLC"],
	["MAAWS Mk4 Mod 1 (Sand)", "launch_MRAWS_sand_F", 2150, "noDLC"],
	["9M135 Vorona (Brown)", "launch_O_Vorona_brown_F", 2250, "noDLC"],
	["9M135 Vorona (Green)", "launch_O_Vorona_green_F", 2300, "noDLC"],
...
[
	["9mm 10Rnd Mag", "10Rnd_9x21_Mag", 15],
	...
	["6.5mm 30Rnd STANAG Mag", "30Rnd_65x39_caseless_mag", 45],
	...
	["6.5mm 200Rnd Tracer (Yellow) Belt Case", "200Rnd_65x39_cased_Box_Tracer",350],
	//["7.62mm 10Rnd Mag", "10Rnd_762x51_Mag", 15],
	["7.62mm 10Rnd Mag", "10Rnd_762x54_Mag", 35],
	["7.62mm 20Rnd Mag", "20Rnd_762x51_Mag", 70],
	["7.62mm 30Rnd Mag", "30Rnd_762x39_Mag_F", 105],
	...
	["9.3mm 150Rnd Belt", "150Rnd_93x64_Mag", 1000],
...
[
	...
	["Suppressor 5.56mm (Khaki)", "muzzle_snds_m_khk_F", 400, "item", "noDLC"],
	["Suppressor 5.56mm (Sand)", "muzzle_snds_m_snd_F", 400, "item", "noDLC"],
	["Suppressor 5.8mm", "muzzle_snds_58_blk_F", 400, "item"],
	["Suppressor 5.8mm (Hex)", "muzzle_snds_58_hex_F", 400, "item"],
	["Suppressor 5.8mm (G Hex)", "muzzle_snds_58_ghex_F", 400, "item"],
	["Suppressor 6.5mm", "muzzle_snds_H", 400, "item"],
	["Suppressor 6.5mm (Khaki)", "muzzle_snds_H_khk_F", 400, "item", "noDLC"],
	["Suppressor 6.5mm (Sand)", "muzzle_snds_H_snd_F", 400, "item", "noDLC"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 500, "item"],
	["Suppressor 6.5mm LMG (Black)", "muzzle_snds_H_MG_blk_F", 500, "item", "noDLC"],
	["Suppressor 6.5mm LMG (Khaki)", "muzzle_snds_H_MG_khk_F", 500, "item", "noDLC"],
	["Suppressor 6.5mm Stealth", "muzzle_snds_65_TI_blk_F", 500, "item"],
	["Suppressor 6.5mm Stealth (Hex)", "muzzle_snds_65_TI_hex_F", 500, "item"],
	["Suppressor 6.5mm Stealth (G Hex)", "muzzle_snds_65_TI_ghex_F", 500, "item"],
	...
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 700, "item"],
	["Suppressor 9.3mm", "muzzle_snds_93mmg", 700, "item"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 700, "item"],
	["Bipod (NATO)", "bipod_01_F_blk", 400, "item", "noDLC"],
	["Bipod (CSAT)", "bipod_02_F_blk", 400, "item", "noDLC"],
	["Bipod (AAF)", "bipod_03_F_blk", 400, "item", "noDLC"],
	["Bipod (MTP)", "bipod_01_F_mtp", 400, "item", "noDLC"],
	["Bipod (Hex)", "bipod_02_F_hex", 400, "item", "noDLC"],
	["Bipod (Olive)", "bipod_03_F_oli", 400, "item", "noDLC"],
	["Bipod (Sand)", "bipod_01_F_snd", 400, "item", "noDLC"],
	["Bipod (Tan)", "bipod_02_F_tan", 400, "item", "noDLC"],
	["Bipod (Khaki)", "bipod_01_F_khk", 400, "item", "noDLC"],
	["Flashlight", "acc_flashlight", 100, "item"],
	["Pistol Flashlight" ,"acc_flashlight_pistol", 100, "item"],
	["IR Laser Pointer", "acc_pointer_IR", 100, "item"],
	["Yorris Sight (Zubr Revolver)", "optic_Yorris", 200, "item"],
	["MRD Sight (4-Five Pistol)", "optic_MRD", 200, "item"],
	["ACO SMG (Red)", "optic_aco_smg", 200, "item"],
	["ACO SMG (Green)", "optic_ACO_grn_smg", 200, "item"],
	["ACO (Red)", "optic_Aco", 300, "item"],
	["ACO (Green)", "optic_Aco_grn", 300, "item"],
	["Holosight SMG", "optic_Holosight_smg", 200, "item"],
	["Holosight", "optic_Holosight", 350, "item"],
	["MRCO", "optic_MRCO", 400, "item"],
	["ERCO", "optic_ERCO_blk_F", 400, "item"],
	["ERCO (Khaki)", "optic_ERCO_khk_F", 400, "item"],
	["ERCO (Sand)", "optic_ERCO_snd_F", 400, "item"],
	["ARCO", "optic_Arco", 500, "item"],
	["ARCO (Black)", "optic_Arco_blk_F", 500, "item", "noDLC"],
	["ARCO (G Hex)", "optic_Arco_ghex_F", 500, "item", "noDLC"],
	["RCO", "optic_Hamr", 600, "item"],
	["RCO (Khaki)", "optic_Hamr_khk_F", 600, "item", "noDLC"],
	["MOS", "optic_SOS", 600, "item"],
	["MOS (Khaki)", "optic_SOS_khk_F", 600, "item", "noDLC"],
	["DMS", "optic_DMS", 700, "item"],
	["DMS (G Hex)", "optic_DMS_ghex_F", 700, "item", "noDLC"],
	["Kahlia (Sightless)", "optic_KHS_old", 800, "item"],
	["Kahlia", "optic_KHS_blk", 900, "item"],
	["Kahlia (Hex)", "optic_KHS_hex", 900, "item"],
	["Kahlia (Tan)", "optic_KHS_tan", 900, "item"],
	["AMS", "optic_AMS", 1000, "item"],
	["AMS (Khaki)", "optic_AMS_khk", 1000, "item"],
	["AMS (Sand)", "optic_AMS_snd", 1000, "item"],
	["LRPS", "optic_LRPS", 1200, "item"],
	["LRPS (G Hex)", "optic_LRPS_ghex_F", 1200, "item", "noDLC"],
	["LRPS (Tropic)", "optic_LRPS_tna_F", 1200, "item", "noDLC"],
	["NVS", "optic_NVS", 2000, "item"],
	["TWS", "optic_tws", 30000, "item", "HIDDEN"], // To hide from store list, add "HIDDEN" after "item", like "item", "HIDDEN"]
	["TWS MG", "optic_tws_mg", 24000, "item", "HIDDEN"],
	["Nightstalker", "optic_Nightstalker", 30000, "item", "HIDDEN"]
];
...
[
	...
	["Press Vest", "V_Press_F", 8000, "vest"],
...
[
	...
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 25000, "vehicle","HIDDEN"], //ADED FOR BACKWARD COMPATABILITY BUDDKSI
...
[
	...
	["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 35000, "vehicle", "variant_pawneenormal", "HIDDEN"], // Pawnee - hidden as workaround to resale bug when captured
	["UH-80 Ghost Hawk", "B_Heli_Transport_01_F", 12500, "vehicle", "HIDDEN"], //Ghosthawk - hidden as workaround to resale bug when captured
	["AH-99 Blackfoot", "B_Heli_Attack_01_F", 50000, "vehicle", "HIDDEN"], //Blackfoot - hidden as workaround to resale bug when captured
	["PO-30 Orca (DAGR)", "O_Heli_Light_02_F", 40000, "vehicle", "variant_orcaDAGR", "HIDDEN"], //OrcaDAGR - hidden as workaround to resale bug when captured
	["Mi-48 Kajman", "O_Heli_Attack_02_F", 60000, "vehicle", "HIDDEN"], //Kajman - hidden as workaround to resale bug when captured
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 40000, "vehicle", "HIDDEN"], //Hellcat - hidden as workaround to resale bug when captured
...
[
	...
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 50000, "vehicle", "variant_buzzardCAS", "HIDDEN"], //Buzzard - hidden as workaround to resale bug when captured
	["A-143 Buzzard AA", "A-143 Buzzard AA", 40000, "vehicle",  "variant_buzzardAA", "HIDDEN"], //Buzzard - hidden as workaround to resale bug when captured
	...
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 75000, "vehicle", "HIDDEN"],  //Wipeout - hidden as workaround to resale bug when captured

	["To-199 Neophron CAS", "O_Plane_CAS_02_dynamicLoadout_F", 75000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 75000, "vehicle", "HIDDEN"],   //Neophron - hidden as workaround to resale bug when captured
